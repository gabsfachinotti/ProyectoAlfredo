...
namespace ProyectoAlfredo.Controllers
{
    public class SalesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SaleID,SaleDate,UploadDate,CustomerID,Quantity")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SaleID,SaleDate,UploadDate,CustomerID,Quantity")] Sale sale)
        {
            if (ModelState.IsValid)
            {
